                        ...
                        Row(
                          children: [
                            ...
                            _TopIconBtn(
                              ...
                              icon: const Icon(Icons.settings_outlined, color: _gold, size: 20),
                            ),
                            const SizedBox(width: 8),
                            _TopIconBtn(
                              onTap: () => Navigator.push(context,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          widget.icon,
          const SizedBox(height: 6),
          Text(widget.label, style: const TextStyle(fontFamily: 'Tajawal',
            color: Color(0xFF5A4820), fontSize: 11, fontWeight: FontWeight.w500),
            textAlign: TextAlign.center)])));
  }
}
