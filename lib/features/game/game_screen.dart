...
class GameScreen extends StatefulWidget {
  ...
  // ✅ حالة الوسائل تُمرر من match_board
...
class _GameScreenState extends State<GameScreen>
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                team == 'team1' ? widget.team1Name : widget.team2Name,
      ...
      builder: (_) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.cardBackground,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: const Color(0xFF2D7A5F), width: 2),
          ),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF2D7A5F).withOpacity(0.15),
  ...
  void _useAlt(String team) {
    ...
    setState(() {
      ...
      final others =
      _allQuestions.where((q) => q.id != current.id).toList();
      ...
      builder: (_) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.cardBackground,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(color: const Color(0xFF1A5F8A), width: 2),
          ),
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
    ...
    return AbsorbPointer(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: used ? Colors.white10 : AppColors.surfaceColor,
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
              color: used ? Colors.white12 : AppColors.cardBorderGold,
              width: 1,
            ),
          ),
          child: Row(
            ...
            children: [
              ...
              Text(
                label,
                style: TextStyle(
                  color: used ? Colors.white24 : AppColors.primary,
                  fontSize: 9,
                  fontWeight: FontWeight.bold,
                ),
              ),
                      ...
                      if (widget.isDoubleQuestion)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                                color: const Color(0xFF8B2635), width: 1.5),
                          ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                                color: const Color(0xFF9B59B6), width: 1.5),
                          ),
                          child: Text('🌟 ${widget.bonusPoints} نقطة',
                              style: const TextStyle(
                    ...
                    children: [
                      Expanded(
                        child: Wrap(
                          ...
                          runSpacing: 3,
                          children: [
                            _buildLifeline(emoji: '📞', label: 'اتصال',
                                used: _team1CallUsed,
                                onTap: () => _useCall('team1')),
                            _buildLifeline(emoji: '🔍', label: 'حرف',
                                used: _team1RevealUsed,
                                onTap: () => _useReveal('team1')),
                            _buildLifeline(emoji: '⏳', label: '+30ث',
                                used: _team1ExtendUsed,
                                onTap: () => _useExtend('team1')),
                            _buildLifeline(emoji: '🔀', label: 'بديل',
                                used: _team1AltUsed,
                                onTap: () => _useAlt('team1')),
                          ],
                        ),
                      ...
                      Expanded(
                        child: Wrap(
                          ...
                          children: [
                            _buildLifeline(emoji: '📞', label: 'اتصال',
                                used: _team2CallUsed,
                                onTap: () => _useCall('team2')),
                            _buildLifeline(emoji: '🔍', label: 'حرف',
                                used: _team2RevealUsed,
                                onTap: () => _useReveal('team2')),
                            _buildLifeline(emoji: '⏳', label: '+30ث',
                                used: _team2ExtendUsed,
                                onTap: () => _useExtend('team2')),
                            _buildLifeline(emoji: '🔀', label: 'بديل',
                                used: _team2AltUsed,
                                onTap: () => _useAlt('team2')),
                          ],
                          ...
                          if (_revealedHint.isNotEmpty)
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(
                                    color: const Color(0xFF2D7A5F), width: 1),
                              ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color: widget.isDoubleQuestion
                                    ? const Color(0xFF8B2635).withOpacity(0.15)
                                    : widget.bonusPoints > 0
                        ...
                        Text(
                          ...
                          style: TextStyle(
                              color: widget.isDoubleQuestion
                                  ...
                                  : AppColors.textSecondary,
                              fontSize: 12,
                              fontWeight: widget.isDoubleQuestion
                                  ? FontWeight.bold
                                  : FontWeight.normal,
                              letterSpacing: 0.5),
                        ),
            ...
            children: [
              Expanded(
                child: TextButton(
                  onPressed: () {
                    Navigator.pop(context);
                    if (!_timesUp && !_showAnswer) _resumeTimer();
                  },
